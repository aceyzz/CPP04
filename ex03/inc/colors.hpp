...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/23 11:25:39 by cedmulle          #+#    #+#             */
/*   Updated: 2024/02/24 08:41:53 by cedmulle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define RST "\033[0m"                     // Reset de la couleur
# define CLRA "\033[2J\033[3J\033[H"       // Clear terminal (supprime historique)
# define CLRS "\033c"                      // Clear terminal (garde historique)
# define CLRL "\033[2K"                    // Clear ligne terminal
# define BOLD "\033[1m"                    // Ecris en gras
# define ITAL "\033[3m"                    // Ecris en italique
# define SOUL "\033[4m"                    // Ecris en souligné
# define BLKS "\033[5m"                    // Ecris en clignotant lent
# define BLKF "\033[6m"                    // Ecris en clignotant rapide
# define BARR "\033[9m"                    // Ecris en barré
